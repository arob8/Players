...
{
    public class BaseballPlayerFactory : IPlayerFactory
    {
        ...
        {
            return new BaseballPlayer(player.Id, player.FirstName != "" ? player.FirstName : null, player.LastName, player.Position, player.Age, avgPositionAgeDiff);
        }
